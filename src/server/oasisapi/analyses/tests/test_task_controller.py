...
from src.server.oasisapi.analyses.task_controller import Controller, TaskParams
...
class TaskController(TestCase):
    def test_get_subtask_signature_returns_the_correct_task_name_with_params_and_linked_tasks(self):
        ...
        sig = Controller.get_subtask_signature(
            'the_task',
            analysis,
            initiator,
            'run_UUID',
...
#        initiator = fake_user()
#
#        sig = Controller.get_generate_inputs_results_callback(analysis, initiator)
#
...
#        initiator = fake_user()
#
#        sig = Controller.get_generate_inputs_error_callback(analysis, initiator)
#
...
#        initiator = fake_user()
#
#        sig = Controller.get_generate_losses_results_callback(analysis, initiator)
#
...
#        initiator = fake_user()
#
#        sig = Controller.get_generate_losses_error_callback(analysis, initiator)
#
...
#
#            @classmethod
#            def get_subtask_signature(cls, task_name, analysis, initiator, run_data_uuid, slug, queue, params):
#                subtasks_list = [
#                    Mock(),
#                    Mock(),
#                ]
#                yield subtasks_list.pop()
#
#            @classmethod
#            def get_generate_losses_results_callback(cls, analysis, initiator):
#                return body
